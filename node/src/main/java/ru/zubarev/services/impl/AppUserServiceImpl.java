    ...
    public String setEmail(AppUser appUser, String email) {
        ...
        if (optional.isEmpty()) {
            ...
            if (response.getStatusCode() != HttpStatus.OK) {
                var msg = String.format("Отправка письма на эектронную почту %s не удалась.", email);
                log.error(msg);
            ...
            return "Этот адрес электронной почты уже используется. Введите корректный email."
